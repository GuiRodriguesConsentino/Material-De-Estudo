...
//       alert(`${member} não pode ser adicionado. Limite atigindo.`)
//    } else {
...
//       alert(`${spaceship.name} não poder ser enviada. Tripulação insuficiente.`)
//    } else {
...
//    const crewLimit = Number(prompt(`Quandos tripulantes a ${name} suporta?`))
